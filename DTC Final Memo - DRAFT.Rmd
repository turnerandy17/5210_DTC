...
Our analysis reveals that the overwhelming majority of suicides are from males. Generationally, Boomers and the Silent generation comprised the highest number of suicides in our data set. Lastly, the majority of suicides affect those in their 'middle-age', typically individuals between the ages of 35-54 years old.
